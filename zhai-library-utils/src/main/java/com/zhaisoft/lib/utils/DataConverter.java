...
public class DataConverter {
	...
	public static String joinStrings(String firstStr, String secondStr) {
		if (Validator.isEffective(firstStr) == false && Validator.isEffective(secondStr) == false)
			return "";
		if (Validator.isEffective(firstStr) == true && Validator.isEffective(secondStr) == false)
			return firstStr;
		if (Validator.isEffective(firstStr) == false && Validator.isEffective(secondStr) == true)
			return secondStr;
	...
	public static String StringFormat(String src, String value, String color) {
		if (!Validator.isEffective(src))
			return "";
		if (!Validator.isEffective(value))
			value = "";
		if (Validator.isEffective(color))
